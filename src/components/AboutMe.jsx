...
const projectTabs = [
  ...
  [
    ...
    {title:"Drawing", desc:"클릭하시면 저의 다른 작품들을 다운받아 보실 수 있습니다.", link:"https://github.com/taylors-gook/portfolio/blob/main/DRAWING.pdf?raw=true"},
  ]
];
          ...
          <div className='right'>
            ...
            <ul className='project_list'>
              {projectTabs[tab].map((item, idx) => {
                const safeLink = item.link && item.link.length > 0 ? item.link : '#';
                  ...
                  return (
                    <li className='project_item' key={idx}>
                      <a
                        ...
                        // optional: aria-label을 추가하면 접근성에 도움됩니다.
